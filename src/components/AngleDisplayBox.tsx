...
const AngleDisplayBox: React.FC<AngleDisplayBoxProps> = ({
    ...
    return (
        <div className="flex flex-col items-center justify-center p-6 border border-neutral-950 dark:border-neutral-100 min-w-52 min-h-80">
            <h3 className="text-lg font-semibold mb-1 text-neutral-950 dark:text-neutral-100">Current Angle</h3>
            ...
            <div className="text-sm text-neutral-500 dark:text-neutral-400 mb-2 mt-4">Trigonometric Functions:</div>
            <div className="text-sm space-y-1">
                <div className="text-red-600 dark:text-red-500">
                  sin = <span className={"text-neutral-950 dark:text-neutral-100"}><InlineMath math={selectedY} /></span>
                </div>
                <div className="text-green-600 dark:text-green-500">
                  cos = <span className={"text-neutral-950 dark:text-neutral-100"}><InlineMath math={selectedX} /></span>
                </div>
                <div className="text-blue-600 dark:text-blue-500">
                  tan = <span className={"text-neutral-950 dark:text-neutral-100"}><InlineMath math={selectedTan} /></span>
                </div>
            </div>
        </div>
    );
